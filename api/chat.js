...
async function selectFiles(q) {
  ...
  // Sort by score descending, prefer part1 over part2 when scores tie
  scored.sort((a, b) => {
  ...
  // Take top 3, but skip part2 if part1 of same file is already included
  const selected = [];
...
module.exports = async function(req, res) {
  ...
  try {
    ...
    // Append YouTube links to system prompt so Claude can reference them
